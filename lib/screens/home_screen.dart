...
import 'package:sinkpro/constants/app_constants.dart';
import 'package:sinkpro/constants/app_images.dart';
import 'package:sinkpro/theme/app_colors.dart';
import 'package:sinkpro/theme/app_text_style.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(height: 100.h, AppImages.sinkPro),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 30.h),
                  Text(
                    '2025 Simply Sinks LLC. All rights reserved.',
                    style: AppTextStyle(
